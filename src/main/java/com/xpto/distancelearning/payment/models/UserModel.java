package com.xpto.distancelearning.payment.models;
...
public class UserModel implements Serializable {
    ...
    @Id
    // @GeneratedValue(strategy = GenerationType.AUTO) // I do not need to generate the UUID in the code as I am receiving it from the authuser service
    private UUID userId;
