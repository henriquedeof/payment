package com.xpto.distancelearning.payment.specifications;
...
// This class works in conjunction with the ResolverConfig class to create a specification for the PaymentModel class.
